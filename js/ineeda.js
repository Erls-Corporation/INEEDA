...
function detailPlacesCB(place,status){
    if (status == google.maps.places.PlacesServiceStatus.OK) {
      ...
      $('.ui-listview').append('<li data-role="list-divider">Address</li><li>'+place.formatted_address+'</li><li data-role="list-divider">Rating</li><li>'+ratingValue+'</li><li data-role="list-divider">Call</li><li data-icon="false"><a href="tel:'+phoneNum+'">'+phoneNum+'</a></li>');
       $('ul').listview('refresh');
    }
}
